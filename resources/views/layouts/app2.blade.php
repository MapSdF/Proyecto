...
<body>
    ...
    <a class="nav-link dropdown-toggle" href="#" id="navCursos" role="button" data-bs-toggle="dropdown" aria-expanded="false">
         Autorizaciones solfichads
    </a>
    <ul class="dropdown-menu" aria-labelledby="navCursos">
        <li><a class="dropdown-item" href="{{ route('solicitudes.index') }}">Mostrar</a></li>
        <li><a class="dropdown-item" href="{{ route('solicitudes.create') }}">Agregar</a></li>
    </ul>
</li>
